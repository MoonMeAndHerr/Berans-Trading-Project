                                        ...
                                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                                            <div>
                                                <a href="index.html" class="d-inline-block auth-logo">
                                                    <img src="/beranstrading/assets/images/beranslogo.png" alt="" height="70">
                                                </a>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> BeransTrading</p>
                            </div>
                        </div>
                    </div>
                </div>
