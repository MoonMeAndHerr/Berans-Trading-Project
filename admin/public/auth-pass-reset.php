                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                                    ...
                                    <div class="p-2">
                                        <form method="POST" action="../private/reset_password_backend.php">
                                            ...
                                            <div class="text-center mt-4">
                                                <button class="btn btn-success w-100" type="submit" name="resetpassword">Send Reset Code</button>
                                            </div>
                                        </form><!-- end form -->
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-4"> 
                                    ...
                                    <div class="p-2">
                                        <form method="POST" action="../private/reset_password_backend.php">
                                            ...
                                            <div class="text-center mt-4">
                                                <button class="btn btn-success w-100" type="submit" name="submitcode">Submit Code</button>
                                            </div>
                                        </form><!-- end form -->
                                    </div>
                                </div>
                                                ...
                                                <div class="p-2 mt-4">
                                                    <form method="POST" action="../private/reset_password_backend.php">
                                                       ...
                                                       <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="password-input">Retype Password</label>
                                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                                <input type="password" class="form-control pe-5" name="repassword" placeholder="Enter password again" id="password-input" required>
                                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                                                            </div>
                                                        </div>
                        ...
                        <?php
                                ...
                                header("Location: auth-signin-basic");
