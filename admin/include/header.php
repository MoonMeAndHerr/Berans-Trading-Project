            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="dashboard-projects.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="/beranstrading/assets/images/beranslogodark.png" alt="Berans Logo" height="50" style="margin: 10px 10px;">
                        </span>
                        <span class="logo-lg">
                            <img src="/beranstrading/assets/images/beranslogodark.png" alt="Berans Logo" height="60" style="margin: 10px 10px;">
                        </span>
                    </a>

                    <a href="dashboard-projects.php" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="/beranstrading/assets/images/beranslogo.png" alt="Berans Logo" height="50" style="margin: 10px 10px;">
                        </span>
                        <span class="logo-lg">
                            <img src="/beranstrading/assets/images/beranslogo.png" alt="Berans Logo" height="60" style="margin: 10px 10px;">
                        </span>
                    </a>
                </div>
